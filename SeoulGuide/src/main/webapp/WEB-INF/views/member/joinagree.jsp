...
<link rel="stylesheet" href="<c:url value="/resources/css/member/joinagree.css"/>">
<link rel="stylesheet" href="<c:url value="/resources/css/member/common.css"/>">
	...
	<section class = "content-wrap" id="loginpage">
		...
		<h1>회원가입 신청 약관</h1>
	        <form class="contract" action="joinform">
	         	<div>
	                <p><input type="checkbox" required> 약관에 동의하면 체크해주세요</p>
	            </div>
	            <div class="text">
	            	가. 개인정보의 수집 및 이용 목적
	 
	                '서울 함께 걷는 길'은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
	            ...
	            <div class = "boxp">
	            	<p><input type="submit" value="회원가입하기" class="box"><p>
	            </div>
	        </form>
		</div>
	</section>
