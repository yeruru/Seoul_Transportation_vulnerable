	...
	<section class="content-wrap" id="loginpage">
		<form action="passwordsearch" method="POST">
			<div class="loginbackground">
				<p>비밀번호 찾기</p>
				<div>
					<div class="emailcheck"><input type="text" name="email"
						id="email" placeholder=" 이메일" required>
						<button type="button" id="emailChk" class="doubleChk">인증번호요청</button></div>
				</div>
				<div>
					<div class="emailcheck2"><input id="sm_email2" type="text" title="인증번호 입력" disabled required />
						<button type="button" id="emailChk2" class="doubleChk">이메일인증</button>
					</div>

				</div>
				<div>
					<div><span class="point successEmailChk">이메일 입력후 인증번호
							보내기를 해주십시오.</span> <input type="hidden" id="emailDoubleChk" /></div>
				</div>
				<div>
